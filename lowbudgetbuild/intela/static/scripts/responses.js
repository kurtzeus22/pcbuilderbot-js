function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>ASRock H610M-HDV <br>link: <a href = https://pangoly.com/en/review/asrock-h610m-hdv>ASRock H610M-HDV </a> <br><br>ASRock B660M-HDV <br>link: <a href = https://pangoly.com/en/review/asrock-b660m-hdv>ASRock B660M-HDV </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "asrock h610m-hdv") {
        return "Okay, H610M-HDV. Supports 12th Gen Intel® Core™ Processors (LGA1700); 5 Phase Power Design; Supports DDR4 3200MHz. <br>To learn more: <a href = https://www.asrock.com/mb/Intel/H610M-HDV/ >ASRock H610M-HDV </a><br><br> Type Okay once you add this to cart.";
    }
    else if (input == "asrock b660m-hdv") {
        return "Okay, B660M-HDV. This motherboard is capable of accomadating multiple M. 2 storage devices, one of which can support PCI Express 4.0 M. 2 SSD. <br>To learn more: <a href = https://www.asrock.com/mb/Intel/B660M-HDV/#:~:text=This%20motherboard%20is%20capable%20of,lightning%20fast%20data%20transferring%20experience>ASRock B660M-HDV </a> <br><br> Type Okay once you add this to cart.";
    }
