function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>MSI A320M-A PRO MAX <br>link: <a target=_blank target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=26>MSI A320M-A PRO MAX </a> <br><br>MSI B450M-A PRO MAX <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=27>MSI B450M-A PRO MAX </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "msi a320m-a pro max") {
        return "Okay, A320M-A Pro Max is an AMD AM4 motherboard inspired from architectural design, with Core Boost, DDR4 Boost, Turbo M.2, USB 3.2 Gen1. <br>To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=26>MSI A320M-A PRO MAX </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "msi b450m-a pro max") {
        return "Okay, B450M-A Pro Max is an AMD AM4 motherboard inspired from architectural design, with Core Boost, DDR4 Boost, Turbo M.2, USB 3.2 Gen1. <br>To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=27>MSI B450M-A PRO MAX </a> <br><br> Type Okay once you add this to cart.";
    }
