function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>ASRock H510M-HDV <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=53>ASRock H510M-HDV</a> <br><br>ASUS TUF B450M <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=54>ASUS TUF B450M </a> <br><br>Gigabyte B450M<br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=55>Gigabyte B450M </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "asrock h510m-hdv") {
        return "Okay, H510M-HDV has a High Density Glass Fabric PCB design that reduces the gaps between the PCB layers to protect the motherboard against electrical shorts caused by humidity.<br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=53>ASROCK H510M-HDV </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "asus tuf b450m") {
        return "Okay, ASUS TUF B450M is an AMD B450 mATX gaming motherboard with Aura Sync RGB LED lighting, DDR4 4400MHz support, Dual M. 2, and native USB 3.1 Gen 2. <br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=54 >ASUS TUF B450M </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "gigabyte b450m") {
        return "Okay, Gigabyte B450M is an easy-to-use utility that combines the speed of SSDs with the high capacity of HDDs into a single drive, enhances the read/write speeds of the device to match that of SSDs, bolsters data performance for incredible value, and transforms the everyday PC to a performance driven system.<br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=55 >Gigabyte B450M </a> <br><br> Type Okay once you add this to cart.";
    }
