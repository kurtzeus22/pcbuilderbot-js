...
function send_message(){
    ...
    var mobile_num=jQuery("#mobile_num").val();
    ...
    if(name==""){
        ...
        jQuery.ajax({
            ...
            type:'post',
            data:'&name='+name+'&email='+email+'&mobile_num='+mobile_num+'&comment='+comment,
...
function user_register(){
    ...
    if(name==""){
        ...
        jQuery.ajax({
            ...
            success:function(result){
                if(result=='present'){
                    jQuery('#email_error').html('Email Address is Already in Use');
                }
                if(result=='insert'){
