function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>ASUS PRIME B365M-A <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=74>ASUS PRIME B365M-A </a> <br><br>Gigabyte H310M A <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=75>Gigabyte H310M A </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "asus prime b365m-a") {
        return "Okay, The Intel B365 is a single-chipset design that supports Socket 1151 for 9th Gen and 8th Gen Intel Core, Pentium Gold and Celeron processors.<br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=74 >ASUS PRIME B365M-A </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "gigabyte h310m a") {
        return "Okay, Intel H310 Ultra Durable motherboard with GIGABYTE 8118 Gaming LAN, PCIe Gen2 x2 M.2, Anti-Sulfur Resistor, Intel CNVi WIFI upgradable slot, Smart Fan 5, DualBIOS, CEC 2019 ready.<br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=75 >Gigabyte H310M A </a> <br><br> Type Okay once you add this to cart.";
    }
