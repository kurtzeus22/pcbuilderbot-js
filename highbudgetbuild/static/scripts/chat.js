...
function firstBotMessage() {
    let firstMessage = "Alright High Budget it is! Now, tell me what CPU do you want to have? (Pick between Intel and AMD)"
...
function getResponse() {
    ...
    else if (userText == "intel core i9-9900k") {
        window.location.href="intela/intela.html";
    }
    else if (userText == "intel core i9-10920x") {
        window.location.href="intelb/intelb.html";
    }
    else if (userText == "ryzen 9 3590x") {
        window.location.href="amda/amda.html";
    }
    else if (userText == "ryzen threadripper 2950x") {
