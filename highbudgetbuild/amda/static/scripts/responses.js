function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>Gigabyte B550M DS3H AC <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=78>Gigabyte B550M DS3H AC </a> <br><br>MSI A520M-A PRO <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=79>MSI A520M-A PRO </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "gigabyte b550m ds3h ac") {
        return "Okay, The Gigabyte B550M DS3H gaming motherboard comes with the proven B550 chipset. The unit is good for gamers, PC designers, and movie buffs.<br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=78 >Gigabyte B550M DS3H AC </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "msi a520m-a pro") {
        return "Okay, Featuring stable functionality and high-quality assembly, PRO series motherboards provide not only optimized professional workflows but also less troubleshooting and longevity.<br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=79 >MSI A520M-A PRO </a> <br><br> Type Okay once you add this to cart.";
    }
