function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>ASRock X399M TAICHI <br>link: <a href = https://www.asrock.com/mb/AMD/X399M%20Taichi/index.asp#:~:text=Designed%20with%20an%2011%2DPower,for%20advanced%20gamers%20as%20well >ASRock X399M TAICHI </a> <br><br>Gigabyte X399 Designare EX <br>link: <a href = https://www.gigabyte.com/Motherboard/X399-DESIGNARE-EX-rev-10#:~:text=GIGABYTE%20X399%20motherboards%20feature%20a,bandwidth%20possible%20to%20the%20user >Gigabyte X399 Designare EX </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "asrock x399m taichi") {
        return "Okay, Designed with an 11-Power-Phase Design, this motherboard features sturdy components and completely smooth power delivery to the CPU.<br> To learn more: <a href = https://www.asrock.com/mb/AMD/X399M%20Taichi/index.asp#:~:text=Designed%20with%20an%2011%2DPower,for%20advanced%20gamers%20as%20well >ASRock X399M TAICHI </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "gigabyte x399 designare ex") {
        return "Okay, GIGABYTE X399 motherboards feature a unique PCI Express design that utilizes 100% of all 48 lanes from the CPU when in a 4-Way or 3-Way graphics configuration providing the full bandwidth available and provide the best graphics bandwidth possible to the user. <br> To learn more: <a href = https://www.gigabyte.com/Motherboard/X399-DESIGNARE-EX-rev-10#:~:text=GIGABYTE%20X399%20motherboards%20feature%20a,bandwidth%20possible%20to%20the%20user >Gigabyte X399 Designare EX </a> <br><br> Type Okay once you add this to cart.";
    }
