function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>ASRock X399M TAICHI <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=80>ASRock X399M TAICHI </a> <br><br>Gigabyte X399 Designare EX <br>link: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=81>Gigabyte X399 Designare EX </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "asrock x399m taichi") {
        return "Okay, Designed with an 11-Power-Phase Design, this motherboard features sturdy components and completely smooth power delivery to the CPU.<br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=80 >ASRock X399M TAICHI </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "gigabyte x399 designare ex") {
        return "Okay, GIGABYTE X399 motherboards feature a unique PCI Express design that utilizes 100% of all 48 lanes from the CPU when in a 4-Way or 3-Way graphics configuration providing the full bandwidth available and provide the best graphics bandwidth possible to the user. <br> To learn more: <a target=_blank href = https://pcbuilderbot.000webhostapp.com/product.php?id=81 >Gigabyte X399 Designare EX </a> <br><br> Type Okay once you add this to cart.";
    }
