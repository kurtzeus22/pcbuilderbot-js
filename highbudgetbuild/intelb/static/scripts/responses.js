function getBotResponse(input) {
    //custom
    if (input == "next") {
        return "So now, let us proceed to the Motherboard. <br>I recommend the following: <br><br>ASRock X299 Steel Legend <br>link: <a href = https://www.asrock.com/mb/Intel/X299%20Steel%20Legend/ >ASRock X299 Steel Legend </a> <br><br>Gigabyte GA-X299-UD4-PRO <br>link: <a href = https://www.gigabyte.com/Motherboard/X299-UD4-Pro-rev-10 >Gigabyte GA-X299-UD4-PRO </a> <br><br>Pick one, make sure it is final. Then I will explain it to you!";
    }

    //motherboard
    else if (input == "asrock x299 steel legend") {
        return "Okay, ASRock X299 Steel Legend is Designed with a 11 Power Phase design, this motherboard features sturdy components and completely smooth power delivery to the CPU.<br> To learn more: <a href = https://www.asrock.com/mb/Intel/X299%20Steel%20Legend/ >ASRock X299 Steel Legend </a> <br><br> Type Okay once you add this to cart.";
    }
    else if (input == "gigabyte ga-x299-ud4-pro") {
        return "Okay, Push your computing experience to the limit with the X299 UD4 Pro LGA 2066 ATX Motherboard. Designed for enthusiasts and professionals who run demanding applications, the ATX motherboard features the X299 chipset for Intel processors using the LGA 2066 socket.<br> To learn more: <a href = https://www.gigabyte.com/Motherboard/X299-UD4-Pro-rev-10 >Gigabyte GA-X299-UD4-PRO </a><br><br> Type Next once you add this to cart.";
    }
